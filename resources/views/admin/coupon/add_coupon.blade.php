        ...
        <div class="position-center">
          <form role="form" action="{{URL::to('/add-coupon-code')}}" method="post">
            ...
            <div class="form-group">
              ...
              <input type="date" name="coupon_date_start" class="form-control" id="exampleInputEmail1">
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Ngày kết thúc</label>
              <input type="date" name="coupon_date_end" class="form-control" id="exampleInputEmail1">
            </div>
            <div class="form-group">
