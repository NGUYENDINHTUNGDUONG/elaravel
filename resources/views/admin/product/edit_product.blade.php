        ...
        <div class="position-center">
          ...
          <form role="form" action="{{URL::to('/update-product/'.$edit_product->product_id )}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <textarea style="resize: none" row="8" class="form-control" id="exampleInputPassword1" name="product_desc">{{$edit_product->product_desc}}</textarea>
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Nội dung sản phẩm</label>
              <textarea style="resize: none" row="8" class="form-control" id="exampleInputPassword1" name="product_content">{{$edit_product->product_content}}</textarea>
            </div>
            <div class="form-group">
